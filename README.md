...
In [Project1](https://github.com/Seymour22/Predictive-modelling/blob/main/Project%201:%20Predict%20epilepsy%20syndrome%20from%20imaging%20data.ipynb) we use Lasso, logistic regression and support vector machine for predicting the type of epilepsy syndrome (SDx) from T1W MRI and DTI data. We then build a neural network using the Tensorflow library and compare performances.
